        ...
        <div class="main-content-inner">
            <div class="breadcrumbs" id="breadcrumbs">
                ...
                <div class="nav-search" id="nav-search">
                    <a class="btn-green-white" href="/teacher/pubTest">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <table class="table">
                            ...
                            <thead>
                            <tr>
                                <th class="center" width="45%"><%= item.get("test_topic")%>
                                </th>
                                <th class="center" width="13%"><%= item.get("pub_time")%>
                                </th>
                                <th class="center" width="11%"><a
                                        href="/teacher/pubQue/<%= item.get("test_id")%>">上传</a>
                                    <a href="/teacher/detailTest/<%= item.get("test_id")%>">查看</a>
                                </th>
                            </tr>
                            </thead>
                            <%}%>
...
<script type="text/javascript">
    window.jQuery || document.write("<script src='/public/javascripts/jquery-2.0.3.min.js'<script>");
</script>
